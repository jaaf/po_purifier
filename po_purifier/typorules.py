#!/usr/bin/python
# coding: utf8 
# trois croisillons indique une règle alternative non retenue
...
#sr.append([r'(\w)([  ]*)([?!;])',r'\1 \3',r'place une espace fine insécable avant une ponctuation double sauf (:) (élimine les autres espaces)'])
...
#Règles relatives à l'écriture des nombres
